...
final as (
    ...
    select
        ...
        customers_locations_joined.city_name,
        customers_locations_joined.state_name,
        customers_locations_joined.zip_code,
    ...
    left join customers_locations_joined
        on customers.customer_id = customers_locations_joined.customer_id
